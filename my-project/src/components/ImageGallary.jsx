         ...
         <h5 class="text-center  ml-4 mb-3 mt-3">Add Image</h5>
          <table className="">
           <tr>
            <td>
              <div class="form-group ml-3">
                <input type="text" name="name" className="mb-4"onChange={(e) => setName(e.target.value)} placeholder="Title"/>
              </div>
            </td>
           </tr>
           ...
           <tr>
            <td>
             <div class="form-group">
              <textarea type="text" name="desc" className="mb-4"  rows="3" cols="23" onChange={(e) => setDesc(e.target.value)} placeholder="category" />
             </div>
            </td>
           </tr>
           ...
           <tr>
            <td>
             <div class="form-group">
              <textarea type="text" name="shortDesc" className="mb-4"  rows="3" cols="23" onChange={(e) => setShortDesc(e.target.value)} placeholder="short description" />
             </div>
            </td>
           </tr>
           ...
           <tr>
            <td>
             <div class="form-group">
              <textarea type="text" name="longDesc" className="mb-4"  rows="3" cols="23" onChange={(e) => setLongDesc(e.target.value)} placeholder="long description" />
             </div>
            </td>
           </tr>
